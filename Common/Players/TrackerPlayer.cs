...
namespace TerraTracker.Common.Players {
    ...
    public class TrackerPlayer : ModPlayer {
        public override void Load() {
            IL.Terraria.Player.SellItem += PlayerSoldItem;
        }
        ...
        public override bool PreHurt(bool pvp, bool quiet, ref int damage, ref int hitDirection, ref bool crit, ref bool customDamage, ref bool playSound, ref bool genGore, ref PlayerDeathReason damageSource, ref int cooldownCounter) {
            ...
            ModContent.GetInstance<StatDamageBlocked>().preDefenseDamage = (uint)damage;
        ...
        public override void Hurt(bool pvp, bool quiet, double damage, int hitDirection, bool crit, int cooldownCounter) {
            ...
            TrackedStat.AddUInt<StatDamageReceived>((uint)damage);

            StatDamageBlocked damageBlockStat = ModContent.GetInstance<StatDamageBlocked>();
            damageBlockStat.theStat.uintStat += damageBlockStat.preDefenseDamage - (uint)damage;
        }
        ...
        public override void OnHitNPC(Item item, NPC target, int damage, float knockback, bool crit) {
            ...
            AddToDamageStats((uint)damage, item.DamageType, crit);
        }
        ...
        public override void OnHitNPCWithProj(Projectile proj, NPC target, int damage, float knockback, bool crit) {
            ...
            AddToDamageStats((uint)damage, proj.DamageType, crit);
        }
